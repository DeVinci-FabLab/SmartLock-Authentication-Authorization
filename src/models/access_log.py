...
class AccessLog(Base):
    ...
    user_id = Column(String, nullable=True, index=True)  # UUID Keycloak (null si badge inconnu)
    ...
    reason = Column(String, nullable=True)               # "no_permission", "card_not_registered", "expired", etc.
