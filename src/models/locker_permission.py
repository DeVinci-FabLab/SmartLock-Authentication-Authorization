...
class Locker_Permission(Base):
    ...
    user_id = Column(String, index=True, nullable=True)            # UUID de l'utilisateur Keycloak
    ...
    __table_args__ = (
        ...
        UniqueConstraint('locker_id', 'role_name', 'user_id', name='unique_permission_target'),
    )